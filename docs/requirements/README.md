...
2026-09-21 — панель настроек стала двухуровневым меню: корневой список
"Аккаунт"/"Внешний вид" + кнопка выхода, переключатели языка/темы и
выход перенесены в неё из сайдбара, который теперь заканчивается сразу
после счётчиков). Дальше —
