...
2026-09-21 — переупорядочивание задач/целей/привычек/категорий больше не
роняет запросы дедлоками, бездатная задача больше не зависает на Today
навсегда, новые задачи/цели/привычки добавляются в конец списка, у
привычек появилось расписание по дням недели с учитывающим его streak и
отдельная страница истории "/habits" ("03.02. Habit History"), плюс
ранее добавленная "13. Reminders"). Дальше —
поддерживать в актуальном состоянии по `<WhenToUpdate>` из
